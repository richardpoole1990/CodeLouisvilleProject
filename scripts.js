...
carpetInfo.onclick = function() {                       //Listens for button click
    if (infoShow.style.display == 'flex') {        //Checks current style display, and if block
        infoShow.style.display = 'none';                // change to none
        infoShow.innerHTML = " ";                       // blank out HTML
        temperment.innerHTML = " ";
        husbandry.innerHTML = " ";
        diet.innerHTML = " ";                       
       }
    else {
        ...
        infoShow.innerHTML += "<strong>Temperment:</strong> Aside from a strong feeding response, docile and easy to handle.";
        infoShow.innerHTML += "<strong>Husbandry:</strong> Temps should be around 90\xB0 Ferenheit. Humidity should be between 40% and 60%. Some type of branch for the snake to perch on should be provided. Recommended substrate would be dirt, though newspaper and tile are common.";
        infoShow.innerHTML += "<strong>Diet:</strong> Frozen mice or rats.";
       }
};

// When Chemeleon button is clicked, adds HTML information into DOM
chemInfo.onclick = function() {
    if (infoShow.style.display == 'flex') {
        infoShow.style.display = 'none';                // change to none
        infoShow.innerHTML = " ";                       // blank out HTML
        temperment.innerHTML = " ";
        husbandry.innerHTML = " ";
        ...
        infoShow.innerHTML = "<img class='speciesPic' id='chem' src='Images/chem.jpg' alt='Hognose in tank'>"
        infoShow.innerHTML += "<br>Semiarboreal snakes inhabiting Queensland Australia, Jungle Carpets are a popular breed to keep for pets.";
